...
- (JYSortItemView *)sortItmView{
    if (!_sortItmView) {
        _sortItmView = [[JYSortItemView alloc]init];
...
- (void)setTitles:(NSArray *)titles{
    ...
    [[JYItemManager shareitemManager] setSortItemView:self.sortItmView];
